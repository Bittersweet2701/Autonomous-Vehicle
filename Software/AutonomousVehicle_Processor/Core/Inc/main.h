...
#define ADC_MOTOR_VOLTAGE_Pin GPIO_PIN_0
#define ADC_MOTOR_VOLTAGE_GPIO_Port GPIOC
...
#define HCSR04_ECHO2_Pin GPIO_PIN_1
#define HCSR04_ECHO2_GPIO_Port GPIOA
#define HCSR04_ECHO3_Pin GPIO_PIN_2
#define HCSR04_ECHO3_GPIO_Port GPIOA
#define HCSR04_ECHO4_Pin GPIO_PIN_3
#define HCSR04_ECHO4_GPIO_Port GPIOA
#define ADC_BATTERY_VOLTAGE_Pin GPIO_PIN_4
...
#define HCSR04_TRIG1_Pin GPIO_PIN_5
#define HCSR04_TRIG1_GPIO_Port GPIOC
#define BUZZER_Pin GPIO_PIN_0
#define BUZZER_GPIO_Port GPIOB
#define HCSR04_TRIG2_Pin GPIO_PIN_1
#define HCSR04_TRIG2_GPIO_Port GPIOB
#define HCSR04_TRIG3_Pin GPIO_PIN_2
#define HCSR04_TRIG3_GPIO_Port GPIOB
#define JETSON_PARALLEL_BIT4_Pin GPIO_PIN_10
#define JETSON_PARALLEL_BIT4_GPIO_Port GPIOB
#define HCSR04_TRIG4_Pin GPIO_PIN_12
#define HCSR04_TRIG4_GPIO_Port GPIOB
#define MOTOR_SPI_SCK_Pin GPIO_PIN_13
#define MOTOR_SPI_SCK_GPIO_Port GPIOB
#define JETSON_SPI_INT_Pin GPIO_PIN_14
#define JETSON_SPI_INT_GPIO_Port GPIOB
#define BRUSHED_MOTOR_ABE_Pin GPIO_PIN_15
#define BRUSHED_MOTOR_ABE_GPIO_Port GPIOB
...
#define HCSR04_ECHO1_Pin GPIO_PIN_15
#define HCSR04_ECHO1_GPIO_Port GPIOA
...
#define JETSON_PARALLEL_BIT6_Pin GPIO_PIN_2
#define JETSON_PARALLEL_BIT6_GPIO_Port GPIOD
#define JETSON_SPI_SCK_Pin GPIO_PIN_3
#define JETSON_SPI_SCK_GPIO_Port GPIOB
#define JETSON_SPI_MISO_Pin GPIO_PIN_4
#define JETSON_SPI_MISO_GPIO_Port GPIOB
#define JETSON_SPI_MOSI_Pin GPIO_PIN_5
#define JETSON_SPI_MOSI_GPIO_Port GPIOB
#define JETSON_IC2_SCL_Pin GPIO_PIN_6
#define JETSON_IC2_SCL_GPIO_Port GPIOB
#define JETSON_I2C_SDA_Pin GPIO_PIN_7
...
#define JETSON_PARALLEL_CLK_Pin GPIO_PIN_9
#define JETSON_PARALLEL_CLK_GPIO_Port GPIOB
