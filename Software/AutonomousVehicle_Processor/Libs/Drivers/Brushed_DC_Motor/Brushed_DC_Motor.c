 ...
 *      DEFINES
 *********************/
#define DUTY_CYCLE_STOP 25
#define DUTY_CYCLE_LOW 50
#define DUTY_CYCLE_MEDIUM 60
#define DUTY_CYCLE_HIGH 70
...
BRUSHED_DC_Motor_t * BRUSHED_DC_MOTOR_Create(TIM_HandleTypeDef * timer_p,
											...
											DIRECTION_DC_Motor_t direct)
{
	BRUSHED_DC_Motor_t * BRUSHED_DC_Motor_p = malloc(sizeof(BRUSHED_DC_Motor_t));
